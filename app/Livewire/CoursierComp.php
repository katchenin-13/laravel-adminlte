...
class CoursierComp extends Component
{
    ...
    public function addNewCoursier()
    {
        $validatedData = $this->validate([
            ...
            "newCoursiersPhone" => "required|min:10|max:10|regex:/^[0-9]+$/|unique:coursiers,numero_telephone",
            "newCoursiersNump" => "required|min:20|max:20|unique:coursiers,numero_permis_conduire",
            "newCoursiersCni" => "required|min:9|max:9|unique:coursiers,cni",
            "newCoursiersPlaq" => "required|min:20|max:20|unique:coursiers,plaque_immatriculation",
            "newCoursiersEmail" => "required|max:50|email|unique:coursiers,email",
            ...
            "newCoursiersPhone.min" => "Le numero de téléphone du coursier doit être de :min caractères.",
            ...
            "newCoursiersNump.min" => "Le numéro de permis du coursier doit être de :min caractères.",
            ...
            "newCoursiersCni.min" => "La CNI du coursier ne peut être inferieur :min caractères.",
            "newCoursiersCni.max" => "La CNI du coursier ne peut pas dépasser :max caractères.",
            "newCoursiersCni.unique" => " La CNI existe déjà.",
            "newCoursiersPlaq.required" => "Le champ plaque du coursier est requis.",
            "newCoursiersPlaq.min" => "La plaque du véhicule doit être de :min caractères.",
            "newCoursiersPlaq.max" => "La plaque du véhicule ne peut pas dépasser :max caractères.",
            "newCoursiersPlaq.unique" => "La plaque du véhicule existe déjà.",
    ...
    public function updateCoursier(Coursier $coursier)
    {
        $validated = $this->validate([
            ...
            "editCoursiersPhone1" => "required|min:10|max:10|regex:/^[0-9]+$/|unique:coursiers,numero_telephone," . $coursier->id,
            "editCoursiersNump" => "required|min:20|max:20|unique:coursiers,numero_permis_conduire," . $coursier->id,
            "editCoursiersCni" => "required|min:9|max:9|unique:coursiers,cni," . $coursier->id,
            "editCoursiersEmail" => "required|max:50|email|unique:coursiers,email," . $coursier->id,
            "editCoursiersPlaq" => "required|min:20|max:20". $coursier->id,
            "selectedZone" => "required",
            "selectedVehicule" => "required",
            "selectedEmployer" => "required",
        ], [
            ...
            "editCoursiersNump.min" => "Le numéro de permis du coursier doit être de  :min caractères.",
            "editCoursiersNump.max" => "Le numéro de permis du coursier ne peut pas dépasser :max caractères.",
            "editCoursiersNump.unique" => "Le numéro de permis existe déjà.",
            "editCoursiersCni.required" => "Le champ CNI du coursier est requis.",
            "editCoursiersCni.min" => "La CNI du coursier doit être de :min caractères.",
            "editCoursiersCni.unique" => "La CNI existe déjà.",
            ...
            "editCoursiersPlaq.min" => "La plaque du véhicule doit être de :min caractères.",
            "editCoursiersPlaq.max" => "La plaque du véhicule ne peut pas dépasser :max caractères.",
            "editCoursiersPlaq.unique" => "La plaque du véhicule existe déjà.",
            "selectedZone.required" => "Veuillez sélectionner une zone.",
            "selectedEmployer.required" => "Veuillez sélectionner le type d'employé.",
            "selectedVehicule.required" => "Veuillez sélectionner un véhicule.",
        ]);
