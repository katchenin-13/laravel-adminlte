...
Route::middleware(['auth', 'role:manager|superadmin'])->group(function () {
    ...
    Route::get('/payer', [PayementComp::class, 'cinetplay'])->name('payement');

});

Route::middleware(['auth', 'role:coursier|superadmin'])->group(function () {
...
Route::middleware(['auth', 'role:manager'])->group(function () {
 ...
 Route::middleware(['auth', 'role:coursier'])->group(function () {
