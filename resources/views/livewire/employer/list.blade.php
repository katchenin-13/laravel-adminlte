        ...
        <div class="card">
            <div class="card-header bg-gradient-primary d-flex align-items-center">
                <h3 class="card-title flex-grow-1">
                    <i class="fa fa-list fa-2x"></i> Liste des Employeurs
                </h3>

                <div class="card-tools d-flex align-items-center">
                    <a class="btn btn-link text-white mr-4 d-block" wire:click="showProp">
                        <i class="far fa-user"></i> Nouveau Employeur
                    </a>
                    <div class="input-group input-group-md" style="width: 250px;">
                        ...
                        <div class="input-group-append">
                            <button type="button" class="btn btn-default" wire:click="searchEmployer"><i class="fas fa-search"></i></button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width:20%;" class="text-center">Poste</th>
                                <th style="width:20%;" class="text-center">Salaire</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $item->poste }}</td>
                                <td class="text-center">{{ $item->salaire }}</td>
