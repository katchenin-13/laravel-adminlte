            ...
            <div class="card-header bg-gradient-primary d-flex align-items-center">
                ...
                <div class="card-tools d-flex align-items-center">
                    <a class="btn btn-link text-white mr-4 d-block" wire:click="showProp">
                        <i class="fas fa-user-plus"></i> Nouvelle Commune
                    </a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-link" wire:click="showProp({{$item->id}})">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                    <button class="btn btn-link" wire:click="showPropD({{$item->id}})">
