    ...
    <div class="modal-dialog" style="top:50px;">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #15a1e2; color: white;">
                <h5 class="modal-title" >Edition Vehicule</h5>

            </div>

            <form role="form" wire:submit.prevent="updateVehicule({{$editVehiculeid}})">
                 @csrf
                            ...
                            <div class="flex-grow-1 mr-2">
                                ...
                                <div class="form-group">Type de vehicule
                                        {{-- <div class="col-md-12" wire:ignore> --}}
                                                    ...
                                                    wire:model="editVehiculeName" class="form-control @error(" editVehiculeName")
                                                    is-invalid @enderror" name ="editVehiculeName">
                                                @error("editVehiculeName")
