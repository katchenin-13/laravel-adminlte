...
class CommuneComp extends Component
{
    ...
    public function editCOmm(Commune $Commune)
    {
    ...
    public function addProp()
    {
        $validated = $this->validate([
            "newPropModel.nom" => [
                "required",
                Rule::unique("propriete_articles", "nom")->where("type_article_id", $this->selectedCommuner->id)
            ],
