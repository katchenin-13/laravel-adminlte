    ...
    <div class="col-12">
        <div class="card ">
            <div class="card-header  d-flex align-items-center text-white"
                style="background-color: #64350d !important;">
                <h3 class="card-title flex-grow-1"><i class="fa fa-list fa-2x"></i> Liste des domaines</h3>

                <div class="card-tools d-flex align-items-center ">
                    <a class="btn btn-link text-white mr-4 d-block" wire:click="toggleShowAddCategorieForm"><i
                            class="fas fa-user-plus"></i> Nouveau domaine</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-link" wire:click="addNewCategorie"> <i class="fa fa-check"></i>
                                    Valider</button>
                                <button class="btn btn-link" wire:click="toggleShowAddCategorieForm"> <i
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-link" wire:click="editCategorie({{$categorie->id}})"> <i
                                        class="far fa-edit"></i> </button>

                                {{-- <button class="btn btn-link" wire:click="showProp({{$categorie->id}})"> <i
                                        class="fa fa-list"></i> propriétés</button> -
                                <button class="btn btn-link"
                                    wire:click="confirmDelete('{{$categorie->tire}}', {{$categorie->id}})"> <i
